...
BASE_SAVE_DIR="/mnt/ssd1/mwnoh/var-resolution-grid"

declare -a FRAME_SIZES=(56 112 224)
declare -a LOCAL_BLOCK_COUNTS=(32 64 96 128)
declare -a RETRIEVE_SIZES=(16 32 64)
