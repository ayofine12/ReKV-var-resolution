...
ROUTER_OUTPUT="${ROUTER_OUTPUT:-${OUTPUT_DIR}/selective_confidence_lvbench_${VERIFIER}_${GATE_COLUMN}_${GATE_THRESHOLD}.csv}"
...
run_scores() {
  ...
  echo "==== LVBench score run fs${frame_size}_lb${local_block_count}_rs${retrieve_size} cuda=${cuda_devices} ===="
