...
OUTPUT_PATH="${OUTPUT_DIR}/fs224_${VIDEO_ID}_lb${LOCAL_BLOCK_COUNT}_rs${RETRIEVE_SIZE}_fps${SAMPLE_FPS}_rep${REPEATS}_${TIMESTAMP}.txt"

mkdir -p "${OUTPUT_DIR}"

echo "==== Benchmarking fs224 on CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} ===="
